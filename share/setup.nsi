...
!define COMPANY "Pandora Core project"
...
VIAddVersionKey ProductName "Pandora Core"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-pandora executable and locales:
    Delete /REBOOTOK $INSTDIR\pandora.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\pandora-qt.exe
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\pandora-qt.exe
