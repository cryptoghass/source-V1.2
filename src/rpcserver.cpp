...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Pandora server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PND features */
        {"pandora", "masternode", &masternode, true, true, false},
        {"pandora", "masternodelist", &masternodelist, true, true, false},
        {"pandora", "mnbudget", &mnbudget, true, true, false},
        {"pandora", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"pandora", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pandora", "mnsync", &mnsync, true, true, false},
        {"pandora", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"pandora", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use pandorad, or the -server option to pandora-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Pandora Alert\" admin@foo.com\n"),
...
{
    return "> pandora-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17511/\n";
}
