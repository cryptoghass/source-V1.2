...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pandora Core pandora-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pandora-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pandora transaction") + "\n" +
                               "  pandora-tx [options] -create [commands]   " + _("Create hex-encoded pandora transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pandora transaction
