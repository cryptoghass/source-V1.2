...
/** Utility functions used by the PNDR Qt UI.
 */
namespace GUIUtil
{
...
// Render PNDR addresses in monospace font
...
// Parse "pandora:" URI into recipient object, return true on successful parsing
