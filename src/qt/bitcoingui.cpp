                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Pandora-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pandora address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pandora: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Pandora Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pandora Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pandora"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pandora addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pandora addresses"));
    ...
    openAction->setStatusTip(tr("Open a Pandora: URI or payment request"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Pandora Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pandora network", "", count));
}
...
{
    QString strTitle = tr("Pandora Core"); // default title
