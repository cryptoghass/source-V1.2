...
#if defined(NDEBUG)
#error "Pandora cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Pandora Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if( nHeight >= 1 && nHeight <= 2000 ) {
	    nSubsidy = 1 * COIN;
    } else if (nHeight >= 2000 && nHeight < 40000) {
        nSubsidy = 2 * COIN;
    } else if (nHeight >= 40000 && nHeight < 60000) {
        nSubsidy = 10 * COIN;
    } else if (nHeight >= 60000 && nHeight < 80000) {
        nSubsidy = 7 * COIN;
    } else if (nHeight >= 80000 && nHeight < 1000000) {
        nSubsidy = 5 * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
