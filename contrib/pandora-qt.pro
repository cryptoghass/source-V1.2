...
RESOURCES += src/qt/pandora.qrc src/qt/pandora_locale.qrc

TRANSLATIONS += src/qt/locale/pandora_bg.ts \
                src/qt/locale/pandora_de.ts \
                src/qt/locale/pandora_en.ts \
                src/qt/locale/pandora_es.ts \
                src/qt/locale/pandora_fi.ts \
                src/qt/locale/pandora_fr.ts \
                src/qt/locale/pandora_it.ts \
                src/qt/locale/pandora_ja.ts \
                src/qt/locale/pandora_pl.ts \
                src/qt/locale/pandora_pt.ts \
                src/qt/locale/pandora_ru.ts \
                src/qt/locale/pandora_sk.ts \
                src/qt/locale/pandora_sv.ts \
                src/qt/locale/pandora_vi.ts \
                src/qt/locale/pandora_zh_CN.ts \
                src/qt/locale/pandora_zh_TW.ts
