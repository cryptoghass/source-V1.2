...
Pandora now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Pandora, _12_ times over the course of a year totaling _24000_ Pandora.
...
When block `1000000` is reached you'll receive a payment for `1200` Pandora.
 ...
 * vote-many          - Vote on a Pandora initiative
 * vote-alias         - Vote on a Pandora initiative
 * vote               - Vote on a Pandora initiative/budget
