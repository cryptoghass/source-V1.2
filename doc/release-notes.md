Pandora Core version 2.3.1 is now available from:
...
Pandora Core is extensively tested on multiple operating systems using
...
Pandora Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) Pandora address of payment
