UNIX BUILD NOTES
====================
Some notes on how to build Pandora in Unix.
...
memory available when compiling Pandora Core. With 512MB of memory or less
...
If you want to build Pandora-Qt, make sure that the required packages for Qt development
...
# Configure Pandora Core to use our own-built instance of BDB
cd $Pandora_ROOT
...
Security
--------
To help make your Pandora installation more secure by making certain attacks impossible to
