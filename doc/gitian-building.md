...
*Setup instructions for a gitian build of Pandora using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Pandora
...
- [Building Pandora](#building-digiwage)
...
To build Pandora (for Linux, OSX and Windows) just follow the steps under 'perform
